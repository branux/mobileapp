...
namespace Toggl.Foundation.Tests.MvvmCross.ViewModels
{
    public class TimeEntryViewModelCollectionTests
    {
            ...
            public void HasTheSameAmountOfItemsAsThePassedGrouping()
            {
                var grouping =
                    ...
                    .Select(i =>
                    {
                        ...
                        timeEntry.Project.Color.Returns("#FFFFFF");
                        return timeEntry;
        ...
        public class TheTotalTimeProperty : TimeEntryViewModelCollectionTest
        {
            ...
            [Fact]
            public void ConsidersTheTimeServiceTicksAsTheStopTimeForTheCurrentlyRunningTimeEntry()
            {
                //Arrange
                var timeEntries =
                ...
                currentlyRunningTimeEntry.Project.Color.Returns("#FFFFFF");
